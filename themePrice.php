...
<p> This is a List of all theme in range 20$-100$ : </p>
 <div> 
...
$sql = 'SELECT ThemeID, ThemeName, ThemeCost
        From  theme
        WHERE themeCost<=100 AND  themeCost >=20;';
...
if ($result->num_rows > 0) {
 ...
 while($row = mysqli_fetch_array($result)) {
            echo "<tr>";
                echo "<td>" . $row['ThemeID'] . "</td>";
                echo "<td>" . $row['ThemeName'] . "</td>";
                echo "<td>" . $row['ThemeCost'] . "</td>";
