...
<p> This is a List of all planners who have parties assigned tothem </p>
 <div> 
...
$sql = 'SELECT planner.PlannerID,planner.PlannerFName,planner.PlannerLName, party.PartyID
        From  party, planner
        WHERE party.PlannerID = planner.PlannerID ';
